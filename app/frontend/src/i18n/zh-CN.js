...
export default {
    common: {
        ...
        delete: '删除',
        deleteFinish: '删除成功',
        topicNotFound: '未在当前列表中找到该主题，请清除搜索过滤后重试',
        noConnToExport: '没有可导出的连接',
        exportConnOk: '已导出 {count} 个连接',
        importConnOk: '新增 {imported} 个，更新 {updated} 个，跳过 {skipped} 个',
        deleteOk: '确定删除吗？',
        count: '数量',
        refresh: '刷新',
        read: '读取',
    ...
    conn: {
        ...
        oauthTip: 'OAUTHBEARER：请在 SASL 密码框中粘贴静态 Access Token',
        oauthTokenPlaceholder: 'SASL 密码（作为 OAuth Token）',
        sessionToken: 'AWS Session Token',
        sessionTokenOptional: '可选：AWS 会话令牌',
        mskTip: 'AWS MSK IAM：用户名填 AccessKey，密码填 SecretKey，需要启用 TLS',
        use_ssh: '使用 SSH 代理',
        ssh_host: 'SSH 主机',
        ssh_port: 'SSH 端口',
        ssh_user: 'SSH 用户名',
    ...
    node: {
        ...
        logdirs: '磁盘目录',
        logdirsTip: '各 Broker 日志目录的磁盘占用。',
        logdirsPartitions: '分区大小明细（按大小排序，最多 200 条）',
        quotas: '配额',
        addQuota: '添加配额',
        quotaEntityType: '实体类型',
        quotaEntityName: '实体名称',
        quotaEntityNameTip: '留空表示默认实体',
        quotaKey: '配额键',
        quotaValue: '配额值',
        size: '大小',
    },
    topic: {
        ...
        deleteTopic: '删除Topic',
        deleteRecords: '清理消息',
        deleteRecordsScope: '清理范围',
        deleteRecordsAll: '删除全部消息',
        deleteRecordsBefore: '删除指定 offset 之前',
        deleteRecordsOffset: 'Offset（不含）',
        deleteRecordsWarning: '警告：删除的消息不可恢复！',
        deleteRecordsDone: '清理完成',
        reassign: '副本重分配',
        reassignJson: '分区 → 副本列表 JSON',
        reassignTip: '格式 {"0":[1,2]}。副本数组留空或 null 表示取消该分区进行中的重分配。',
        reassignDone: '重分配已提交',
        reassignInvalidJson: 'JSON 格式错误',
    },
    producer: {
        title: "Producer",
    ...
    consumer: {
        ...
        noGroupPlaceholder: "无消费组（直连模式）",
        noGroupOption: "无消费组 (Direct Consume)",
        noGroup: "无消费组",
        groupTooltip: "留空使用无消费组直连消费：不向集群注册消费组、不触发 Rebalance、不产生僵尸组。指定消费组时可跟踪进度与提交 Offset。",
        commitOffsetTooltip: "是否在消费后提交Offset",
        commitOffsetDisabledTip: "无消费组模式下无法提交位移，请先指定消费组",
        isLatest: "默认消费位置",
        ...
        startOffsetTip: '从每个分区的该 offset 开始消费（优先级高于消费位置/时间）',
        localSearch: '本地搜索',
        regex: '正则',
        keyword: '关键词',
        filterModeTip: '切换关键词/正则过滤',
        showAdvanced: '展开高级选项',
        hideAdvanced: '收起高级选项',
        stopAll: '停止全部',
        replay: '消息回放',
        replayTip: '将表格中的 {count} 条消息原样发送到目标 Topic',
        replayTarget: '目标 Topic',
        replayEmpty: '没有可回放的消息',
        replayDone: '已回放 {count} 条消息',
    },
    group: {
        title: "消费者组",
        member: '成员',
        ...
        resetTitle: '重置消费组 Offset',
        resetStrategy: '重置策略',
        resetToEnd: '重置到最新',
        resetToStart: '重置到最早',
        resetToTimestamp: '重置到时间戳',
        resetToAbsolute: '重置到指定 offset',
        resetOffsetValue: 'Offset',
        resetTopics: 'Topics（留空=该组已提交的全部 topic）',
        resetTip: '重置要求消费组没有活跃成员；本应用会先断开自己占用的该组消费者。',
        resetDone: '已重置 {count} 个分区',
        needTimestamp: '请选择时间戳',
    },
    inspection: {
        title: "巡检",
        desc: "巡检Kafka积压情况。",
    ...
    about: {
        ...
        allyAgentTag: "AI 编程助手",
        allyAgentDesc: "一款专注于本地工程的开源桌面级 AI 编程助手。支持本地项目代码理解、文件自动化编辑、任务规划执行与多模型对话协同研发。",
...
sr: {
        ...
        deleteVersion: '删除版本',
        compatibility: '兼容性',
        setCompatibility: '设置兼容性',
        cycleCompatibility: '设置兼容级别',
        urlRequired: '请输入 URL',
    },
};
