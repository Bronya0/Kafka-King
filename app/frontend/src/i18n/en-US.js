export default {
    "common": {
        ...
        "topicNotFound": "Topic not found in the current list, clear the search filter and retry",
        "noConnToExport": "No connections to export",
        "exportConnOk": "Exported {count} connections",
        "importConnOk": "Added {imported}, updated {updated}, skipped {skipped}",
    ...
    "consumer": {
        ...
        "noGroupPlaceholder": "No Group (Direct Consume)",
        "noGroupOption": "No Group (Direct Consume)",
        "noGroup": "No Group",
        "groupTooltip": "Leave empty for direct partition consumption: does not register a consumer group, triggers no rebalance, and leaves no zombie groups. Specify a group to track progress and commit offsets.",
        "commitOffsetTooltip": "Whether to commit Offset after consumption",
        "commitOffsetDisabledTip": "Cannot commit offset without a consumer group. Please specify a group first.",
    ...
    "inspection": {
        ...
        "end": "End offset",
        "alertConfig": "Alert Outgoing",
        "enableAlert": "Enable Alert",
        "webhookUrl": "Webhook URL",
        "webhookUrlPlaceholder": "Enter alert webhook endpoint",
        "customHeader": "Custom Header",
        "customHeaderPlaceholder": "e.g. Authorization: Bearer xxxxx",
        "threshold": "Lag Threshold",
        "thresholdPlaceholder": "Enter lag threshold",
        "messageTemplate": "Message Template",
        "messageTemplatePlaceholder": "Optional. Supported placeholders: [total_lag], [topics], [group], [timestamp]",
        "checkInterval": "Check Interval",
        "checkIntervalPlaceholder": "Check interval (minutes)"
    },
    "settings": {
        "title": "Settings",
        "width": "Window Width",
    ...
    "message": {
        ...
        "alertSendFailed": "Failed to send alert"
    },
    "about": {
        "title": "About",
        ...
        "esKing": "ES-King",
        "newProject": "Featured Project",
        "allyAgent": "Ally Agent",
        "allyAgentTag": "AI Coding Assistant",
        "allyAgentDesc": "An open-source desktop AI coding assistant for local projects. Helps you understand code, edit files, manage tasks, and complete development work through conversation.",
    ...
    "acl": {
        ...
        "delete": "Delete ACL",
        "principal": "Principal",
        "principalPlaceholder": "Enter principal, e.g. User:alice",
        ...
        "permissionTypePlaceholder": "Select permission type"
    }
};
